...
class InternalQNetwork(nn.Module):
    ...
    def __init__(self, state_size, action_size, recurrent_size, seed, fc1_units=64, fc2_units=128):
    ...
    def forward(self, x):
        ...
        recurrent_activation = torch.sigmoid(self.fc3(torch.cat([x1, x2], dim=1)))
